...
//	}
	...
	private void build(File f) {
        ...
        try {
            ...
            Logger.getLogger(PatientSummaryReport.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                            .highlightDetailEvenRows()
                            ...
                            .columns(//add columns
//                                    /*rowNumberColumn,*/ 
                                    itemColumn,  quantityColumn,quantityColumn2,quantityColumn3/*, unitPriceColumn, priceColumn, pricePercColumn*/)
                            .columnGrid(
                                    /*rowNumberColumn,*/itemColumn, quantityColumn,quantityColumn2,quantityColumn3, /*unitPriceColumn,*/ grid.verticalColumnGridList(/*priceColumn, pricePercColumn*/))
//                            .groupBy(itemGroup)
...
//                                                cmp.text("abc").setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                    ...
                                    .newRow().add(cmp.filler().setStyle(stl.style().setTopBorder(stl.pen2Point())).setFixedHeight(8))
                            )
...
//            String gender = bo.getGender().equalsIgnoreCase("M")?"Male":"Female";
		DRDataSource dataSource = new DRDataSource("item", "quantity","quantity2","quantity3");
...
//	}
    ...
    public String generateOrder(String location,String from,String to,LinkedHashMap<String,PatientSummaryReportBo> patientSummaryMap) {
        String filePath="";
        this.from=from;
        this.to = to;
        this.location =location;
        this.patientSummaryMap = patientSummaryMap;
        File f = new File(System.getProperty("java.io.tmpdir")+"\\temp\\PatientSummary"+System.currentTimeMillis() % 1000+".pdf");
