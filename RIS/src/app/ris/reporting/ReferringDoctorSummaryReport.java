...
public class ReferringDoctorSummaryReport {
...
//	}
	...
	private void build(File f) {
        ...
        try {
            ...
            Logger.getLogger(ReferringDoctorSummaryReport.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                                                cmp.text("abc").setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                    ...
                                    .newRow()
                                    .add(cmp.text("REFERRING DOCTOR WISE SCANS REPORT").setStyle(boldCenteredStyle))
                                    .newRow()
                                    .newRow()
                                    .add(cmp.filler().setStyle(stl.style().setTopBorder(stl.pen2Point())).setFixedHeight(10))
                                    ...
                                    .newRow()
                                    .add(cmp.text("Referring Doctor\t:\t\t"+cpt))
                                    .newRow()
...
//	}
    ...
    public String generateOrder(String location,String from,String to,LinkedHashMap<String,PatientSummaryReportBo> patientSummaryMap,LinkedHashMap<String,PatientDetailReportBo> patientDetailMap,String cpt) {
        ...
        this.cpt = cpt;
        File f = new File(System.getProperty("java.io.tmpdir")+"\\temp\\ReferringPhysician"+System.currentTimeMillis() % 1000+".pdf");
