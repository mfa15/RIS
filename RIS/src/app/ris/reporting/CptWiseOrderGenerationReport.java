...
public class CptWiseOrderGenerationReport {
...
//	}
	...
	private void build(File f) {
        ...
        try {
            ...
            Logger.getLogger(CptWiseOrderGenerationReport.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                                                cmp.text("abc").setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                                    cmp.text("Order Details").setStyle(titleStyle).setHorizontalTextAlignment(HorizontalTextAlignment.CENTER),
...
//	}
    ...
    public String generateOrder(LinkedHashMap<String,CptWiseOrderEntryBO> cptWiseOrderMap,String history,PatientBO pbo,String[] orderInfo,boolean flag) {
        ...
        {
            pay = "***** Funded by Government of Punjab *****";
        }
