...
public class FindingWiseSummaryReport {
...
//	}
	...
	private void build(File f) {
        ...
        try {
            ...
            Logger.getLogger(FindingWiseSummaryReport.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                            .highlightDetailEvenRows()
                            ...
                            .columns(//add columns
//                                    /*rowNumberColumn,*/ 
                                    locationColumn,snoColumn,regnoColumn,itemColumn,  quantityColumn,quantityColumn2,quantityColumn3,cptColumn,preDefHistColumn,quantityColumn4,quantityColumn5/*, unitPriceColumn, priceColumn, pricePercColumn*/)
                            .columnGrid(
                                    /*rowNumberColumn,*/locationColumn,snoColumn,regnoColumn,itemColumn, quantityColumn,quantityColumn2,quantityColumn3,cptColumn,preDefHistColumn,quantityColumn4,quantityColumn5, /*unitPriceColumn,*/ grid.verticalColumnGridList(/*priceColumn, pricePercColumn*/))
//                            .groupBy(itemGroup)
...
//                                                cmp.text("abc").setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                    ...
                                    .newRow()
                                    .add(cmp.text("FINDING WISE SCANS REPORT").setStyle(boldCenteredStyle))
                                    .newRow()
                                    .newRow()
                                    .add(cmp.filler().setStyle(stl.style().setTopBorder(stl.pen2Point())).setFixedHeight(10))
...
//            String gender = bo.getGender().equalsIgnoreCase("M")?"Male":"Female";
		DRDataSource dataSource = new DRDataSource("location","sno","regno","item", "quantity","quantity2","quantity3","cpt","predefhist","quantity4","quantity5");
...
//here
                ...
                for(String key:this.patientSummaryMap.keySet())
                {
                    ...
                    if(value.getPatientType() == null) {
                        value.setPatientType("N/A");
                    }
                ...
                for(String key:this.patientDetailMap.keySet())
                {
                    ...
                    if(!print.equalsIgnoreCase(""))
                    {
                        ...
                        dataSource.add("*****************");
                        dataSource.add("Location","S.NO","REG.NO","MRN","Name","Gender","Age","CPT","History","CT Type","Findings");
                    }
                    String cont = "";
            if (value.getContrast().trim().equalsIgnoreCase("N")) {
                cont = "NC";
            } else {
                cont = "C";
            }
